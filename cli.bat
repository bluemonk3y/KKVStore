...
java -cp .;lib/kafka-clients-0.11.1.0-SNAPSHOT.jar;lib/kafka-streams-0.11.1.0-SNAPSHOT.jar;lib/ksql-cli-1.0-SNAPSHOT-standalone.jar -Dlog4j.debug=true  io.confluent.ksql.Ksql local
